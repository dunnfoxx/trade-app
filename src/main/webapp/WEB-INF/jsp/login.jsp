...
<head>
	<meta charset="UTF-8">
	<title>Login FXTM/ Online Treding Broker / FXTM Globle</title>
...
<body>
	...
	<div class="main">
		<div class="other">
<h1>
	Login into MyFXTM, the <br> trusted client portal for FXTM <br> traders for over 10 years. <br> Trade and invest in Forex, <br> CFDs and stocks.
</h1>

<p>Trade on MetaTrader – one of the most popular trading platforms in the <br> world.</p>

<p>Stuck or confused? Your login queries <a href="#">answered</a>
	. You can also <a href="#">get in touch</a></p>
	<p> *T&Cs Apply. Trading is Risky.</p>
...
<ul class="text">
	...
	<!-- <div class="social">
        ...
        <a href="https://instagram.com/rahul_mali_raiwasa?igshid=MTIyMzRjYmRlZg=="><i class="fab fa-instagram"></i></a>
